...
def main_menu():
    class App(tk.Tk):
        def __init__(self):
            ...
            dropdown = ttk.OptionMenu(self, self.selected_option, self.options[0], *self.options,
    ...
    class Frame10(tk.Frame):
        def __init__(self, parent):  # Company of Heroes
            ...
            button1 = tk.Button(self, text="Money", bg='black', fg='red', cursor="cross",
                                command=multi_run_money_coh)
            button1.pack(pady=10)

            button2 = tk.Button(self, text="Gas", bg='black', fg='red', cursor="cross", command=multi_run_gas_coh)
            button2.pack(pady=10)

            button3 = tk.Button(self, text="Ammo", bg='black', fg='red', cursor="cross", command=multi_run_ammo_coh)
            button3.pack(pady=10)
